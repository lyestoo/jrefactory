...
public class RefactoryInstaller {
	...
	private final static double PRETTY_CURRENT_VERSION = 3.5;
	private final static double UML_CURRENT_VERSION = 1.1;
	...
	private void prettySettings(PrintWriter printer, double version)
	{
		...
		if (version < 1.0) {
			...
			printer.println("indent=1");
			printer.println("indent.char=tab");
			printer.println("");
		...
		if (version < 1.05) {
			...
			printer.println("sort.2=Class(Instance,Static)");
			printer.println("");
		...
		if (version < 1.95) {
			...
			printer.println("#  }");
			printer.println("#");
			printer.println("catch.start.line=true");
			printer.println("");
		}
		...
		if (version < 3.25) {
			...
			printer.println("#");
			printer.println("empty.block.single.line=false");
			printer.println("");
		}
